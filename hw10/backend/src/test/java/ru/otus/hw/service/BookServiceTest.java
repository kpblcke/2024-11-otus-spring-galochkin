...
class BookServiceTest {
    ...
    void shouldAddNewBook() {
        BookShortDTO bookShortDTO = new BookShortDTO(0L, "Test_Title_book", 1L, Set.of(1L));
    ...
    void shouldThrowEntityNotFoundExceptionAtInsert() {
        BookShortDTO bookShortDTO = new BookShortDTO(0L, "Test_Title_book", 1111L, Set.of(1L));
    ...
    void shouldUpdateBook() {
        ...
        BookShortDTO bookShortDTO = new BookShortDTO(oldBook.get().getId(), "New title", oldBook.get().getAuthor().getId(), genreIds);
    ...
    void shouldThrowEntityNotFoundExceptionAtUpdate() {
        var oldBook = bookService.findById(1L);
        var genreIds = oldBook.get().getGenres().stream().map(GenreDTO::getId).collect(Collectors.toSet());
        BookShortDTO bookShortDTO = new BookShortDTO(oldBook.get().getId(), "New title", 0L, genreIds);
