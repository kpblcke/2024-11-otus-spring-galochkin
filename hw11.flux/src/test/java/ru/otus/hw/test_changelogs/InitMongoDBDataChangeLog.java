...
public class InitMongoDBDataChangeLog {
    ...
    @ChangeSet(order = "000", id = "dropDB", author = "ily.galochkin", runAlways = true)
    public void dropDB(MongoDatabase database) {
        database.drop();
    }

    @ChangeSet(order = "001", id = "initGenre", author = "ily.galochkin", runAlways = true)
    ...
    @ChangeSet(order = "002", id = "initAuthor", author = "ily.galochkin", runAlways = true)
    ...
    @ChangeSet(order = "003", id = "initBook", author = "ily.galochkin", runAlways = true)
    ...
    @ChangeSet(order = "004", id = "initComment", author = "ily.galochkin", runAlways = true)
